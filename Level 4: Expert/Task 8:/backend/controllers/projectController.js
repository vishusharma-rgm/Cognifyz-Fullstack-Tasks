...
const { invalidateProjectsCache, setProjectsCache } = require("../middleware/cache");
...
async function getProjects(req, res) {
  try {
    ...
    await setProjectsCache(req.user._id, projects);
...
async function createProject(req, res) {
  try {
    ...
    await invalidateProjectsCache(req.user._id);
